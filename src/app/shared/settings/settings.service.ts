...
export class SettingService {
  ...
  constructor(
    ...
    this.applyDefaultThemeSettings();
  }
  ...
  private applyDefaultThemeSettings(): void {
    const defaultDynamicColor = '84, 109, 254, 1';
    this.changeLayoutMode('1');
    this.changeLayoutWidth('1');
    this.changeCardStyle('1');
    this.changeSidebarColor('1');
    this.changeThemeColor('1');
    this.changeSidebarSize('1');
    this.changeLoaderState('2');
    this.changePrimaryColor('1');
    this.changeTopbarColor('white');
    this.changeTopbarColor2('1');
    this.changeSidebarImage('');
    this.changeTopbarImage('1');
    this.changeSidebarColor2(defaultDynamicColor);
    this.changeTopbarColor3(defaultDynamicColor);
    this.changeTopbarHorizontalColor(defaultDynamicColor);
    this.changePrimaryColor1(defaultDynamicColor);
  }
}
