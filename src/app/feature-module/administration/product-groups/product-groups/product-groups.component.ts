...
import { ProductGroupsStateService } from '../services/product-groups-state.service';
...
export class ProductGroupsComponent implements OnInit {
  ...
  constructor(
    private api: ProductGroupsApiService,
    private pagination: PaginationService,
    private groupsState: ProductGroupsStateService,
  ) {
  ...
  private loadPage() {
    ...
    this.api.list(params).subscribe({
      next: (res) => {
        ...
        this.groupsState.setMany(this.tableData);
