...
export class CompaniesComponent {
  ...
  viewDataGet(id: any) {
    ...
    (document.querySelector('.company-details h5') as HTMLImageElement).innerHTML =
      this.econtent.name;
    (document.querySelector('.company-details p') as HTMLImageElement).innerHTML =
      this.econtent.owner;
    (document.querySelector('.industry_type') as HTMLImageElement).innerHTML =
      this.econtent.industry_type;
