...
import {
  ...
  fetchFolderData,
  updateFolder,
} from 'src/app/store/File Manager/filemanager_action';
import { FolderModel } from 'src/app/store/File Manager/filemanager_model';
import {
  selectFileData,
  selectFileLoading,
  selectFolderData,
} from 'src/app/store/File Manager/filemanager_selector';
...
export class FileManagerComponent implements OnInit {
  ...
  editdata(id: any) {
    ...
    (document.querySelector('#file-overview .file-icon i') as HTMLImageElement).className =
      data[0].icon + ' ' + 'text-' + data[0].icon_color;
    ...
    (document.querySelector('#file-overview .file-type') as HTMLImageElement).innerHTML =
      data[0].type;
  }
