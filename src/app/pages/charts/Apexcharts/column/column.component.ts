...
export class ColumnComponent implements OnInit {
  ...
  ngOnInit(): void {
     ...
     * BreadCrumb
     */
    this.breadCrumbItems = [{ label: 'Apexcharts' }, { label: 'Area Charts', active: true }];
    ...
    this._dynamicQuarterLoadedChart(
      '["--vz-primary", "--vz-success", "--vz-warning", "--vz-danger", "--vz-body-color", "--vz-info"]',
    );
    this._dynamicLoadedChart(
      '["--vz-primary", "--vz-success", "--vz-warning", "--vz-danger", "--vz-body-color", "--vz-info"]',
    );
