...
export class HeatmapComponent implements OnInit {
  ...
  ngOnInit(): void {
     ...
     * BreadCrumb
     */
    this.breadCrumbItems = [{ label: 'Apexcharts' }, { label: 'Heatmap Charts', active: true }];

    // Chart Color Data Get Function
    this._basicHeatmapChart('["--vz-success", "--vz-secondary-bg"]');
    this._multipleSeriesChart(
      '["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info", "--vz-warning", "--vz-danger", "--vz-body-color", "--vz-primary", "--vz-secondary-bg"]',
    );
