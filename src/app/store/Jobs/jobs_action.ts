...
export const fetchApplicationSuccess = createAction(
  '[Data] Fetch Application Success',
  props<{ Application: ApplicationModel[] }>(),
);
export const fetchApplicationFailure = createAction(
  '[Data] Fetch Application Failure',
  props<{ error: string }>(),
);
...
export const deleteApplication = createAction('[Data] Delete Application', props<{ id: string }>());
