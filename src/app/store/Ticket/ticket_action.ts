...
export const fetchTicketListSuccess = createAction(
  '[Data] Fetch TicketList Success',
  props<{ Ticket: TicketListModel[] }>(),
);
export const fetchTicketListFailure = createAction(
  '[Data] Fetch TicketList Failure',
  props<{ error: string }>(),
);

// Add Ticket Data
export const addTicket = createAction('[Data] Add Ticket', props<{ newData: TicketListModel }>());
...
// Delete Ticket Data
export const deleteTicket = createAction('[Data] Delete Ticket', props<{ id: string }>());
