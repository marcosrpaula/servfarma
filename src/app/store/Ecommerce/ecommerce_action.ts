...
export const fetchorderListSuccess = createAction(
  '[Data] Fetch orderList Success',
  props<{ order: OrdersModel[] }>(),
);
export const fetchorderListFailure = createAction(
  '[Data] Fetch orderList Failure',
  props<{ error: string }>(),
);

// Customer
export const fetchCustomerListData = createAction('[Data] Fetch CustomerList');
export const fetchCustomerListSuccess = createAction(
  '[Data] Fetch CustomerList Success',
  props<{ Customer: customerModel[] }>(),
);
export const fetchCustomerListFailure = createAction(
  '[Data] Fetch CustomerList Failure',
  props<{ error: string }>(),
);

// Seller
export const fetchSellerListData = createAction('[Data] Fetch SellerList');
export const fetchSellerListSuccess = createAction(
  '[Data] Fetch SellerList Success',
  props<{ Seller: sellerModel[] }>(),
);
export const fetchSellerListFailure = createAction(
  '[Data] Fetch SellerList Failure',
  props<{ error: string }>(),
);

// Add Data
export const addOrder = createAction('[Data] Add Order', props<{ newData: OrdersModel }>());
export const addOrderSuccess = createAction(
  '[Data] Add Order Success',
  props<{ newData: OrdersModel }>(),
);
export const addOrderFailure = createAction('[Data] Add Order Failure', props<{ error: string }>());
...
// Delete Order Data
export const deleteOrder = createAction('[Data] Delete Order', props<{ id: string }>());
...
// Delete Product Data
export const deleteProduct = createAction('[Data] Delete Product', props<{ id: string }>());
...
// Add Customer Data
export const addCustomer = createAction('[Data] Add Customer', props<{ newData: customerModel }>());
...
export const deleteCustomer = createAction('[Data] Delete Customer', props<{ id: string }>());
