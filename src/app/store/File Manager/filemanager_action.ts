...
export const fetchFolderSuccess = createAction(
  '[Data] Fetch Folder Success',
  props<{ Folder: FolderModel[] }>(),
);
export const fetchFolderFailure = createAction(
  '[Data] Fetch Folder Failure',
  props<{ error: string }>(),
);

// File
export const fetchFileData = createAction('[Data] Fetch File');
export const fetchFileSuccess = createAction(
  '[Data] Fetch File Success',
  props<{ File: FileModel[] }>(),
);
export const fetchFileFailure = createAction(
  '[Data] Fetch File Failure',
  props<{ error: string }>(),
);

// Add Folder Data
export const addFolder = createAction('[Data] Add Folder', props<{ newData: FolderModel }>());
...
// Delete Folder Data
export const deleteFolder = createAction('[Data] Delete Folder', props<{ id: string }>());
...
// Add File Data
export const addFile = createAction('[Data] Add File', props<{ newData: FileModel }>());
...
// Update File Data
export const updateFile = createAction('[Data] Update File', props<{ updatedData: FileModel }>());
...
// Delete File Data
export const deleteFile = createAction('[Data] Delete File', props<{ id: string }>());
