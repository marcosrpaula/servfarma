    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.restApiService.getContactData().pipe(
          ...
          catchError((error) => of(fetchCrmContactFailure({ error }))),
        ),
      ),
    ),
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.restApiService.getCompanyData().pipe(
          ...
          catchError((error) => of(fetchCrmCompanyFailure({ error }))),
        ),
      ),
    ),
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.restApiService.getDealData().pipe(
          ...
          catchError((error) => of(fetchCrmDealFailure({ error }))),
        ),
      ),
    ),
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.restApiService.getLeadData().pipe(
          ...
          catchError((error) => of(fetchCrmLeadFailure({ error }))),
        ),
      ),
    ),
  );
