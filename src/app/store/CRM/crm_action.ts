...
import { CompaniesModel, ContactsModel, DealModel, LeadsModel } from './crm_model';

// contact
export const fetchCrmContactData = createAction('[Data] Fetch CrmContact');
export const fetchCrmContactSuccess = createAction(
  '[Data] Fetch CrmContact Success',
  props<{ Contact: ContactsModel[] }>(),
);
export const fetchCrmContactFailure = createAction(
  '[Data] Fetch CrmContact Failure',
  props<{ error: string }>(),
);

// Company
export const fetchCrmCompanyData = createAction('[Data] Fetch CrmCompany');
export const fetchCrmCompanySuccess = createAction(
  '[Data] Fetch CrmCompany Success',
  props<{ Company: CompaniesModel[] }>(),
);
export const fetchCrmCompanyFailure = createAction(
  '[Data] Fetch CrmCompany Failure',
  props<{ error: string }>(),
);

// Deal
export const fetchCrmDealData = createAction('[Data] Fetch CrmDeal');
export const fetchCrmDealSuccess = createAction(
  '[Data] Fetch CrmDeal Success',
  props<{ Deal: DealModel[] }>(),
);
export const fetchCrmDealFailure = createAction(
  '[Data] Fetch CrmContact Failure',
  props<{ error: string }>(),
);
...
export const fetchCrmLeadSuccess = createAction(
  '[Data] Fetch CrmLead Success',
  props<{ Lead: LeadsModel[] }>(),
);
export const fetchCrmLeadFailure = createAction(
  '[Data] Fetch CrmLead Failure',
  props<{ error: string }>(),
);

// Add Contact Data
export const addContact = createAction('[Data] Add Contact', props<{ newData: ContactsModel }>());
...
// Delete Contact Data
export const deleteContact = createAction('[Data] Delete Contact', props<{ id: string }>());
...
// Add Comapny Data
export const addCompany = createAction('[Data] Add Comapny', props<{ newData: CompaniesModel }>());
...
// Delete Company Data
export const deleteCompany = createAction('[Data] Delete Company', props<{ id: string }>());
...
// Add Lead Data
export const addLead = createAction('[Data] Add Lead', props<{ newData: LeadsModel }>());
export const addLeadSuccess = createAction(
  '[Data] Add Lead Success',
  props<{ newData: LeadsModel }>(),
);
export const addLeadFailure = createAction('[Data] Add Lead Failure', props<{ error: string }>());

// Update Lead Data
export const updateLead = createAction('[Data] Update Lead', props<{ updatedData: LeadsModel }>());
...
// Delete Lead Data
export const deleteLead = createAction('[Data] Delete Lead', props<{ id: string }>());
