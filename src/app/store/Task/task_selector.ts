...
export const selectTaskData = createSelector(selectTaskState, (state: TaskState) => state.Task);

export const selectKanbanData = createSelector(selectTaskState, (state: TaskState) => state.Kanban);
