...
export const getLayoutTheme = createSelector(getLayoutState, (state: LayoutState) => state.LAYOUT);
...
export const getTopbarColor = createSelector(getLayoutState, (state: LayoutState) => state.TOPBAR);
