...
export const fetchApikeySuccess = createAction(
  '[Data] Fetch Apikey Success',
  props<{ Apikey: ApikeyModel[] }>(),
);
export const fetchApikeyFailure = createAction(
  '[Data] Fetch Apikey Failure',
  props<{ error: string }>(),
);

// Add Apikey Data
export const addApikey = createAction('[Data] Add Apikey', props<{ newData: ApikeyModel }>());
...
// Delete Apikey Data
export const deleteApikey = createAction('[Data] Delete Apikey', props<{ id: string }>());
